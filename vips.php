...
if (isset($_POST['vip_add']) && !empty($_POST['server_address'])) {
    $class->addVip($_POST);
}
if (isset($_POST['vip_edit']) && !empty($_POST['vip_server']) && !empty($_POST['vip_id'])) {
    $class->editVip($_POST);
}
if (isset($_POST['delete']) && !empty($_POST['vip_id'])) {
    $class->deleteVip($_POST['vip_id']);
}
?>
...
<body class="app">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active" href="vips.php">
                                <span class="nav-icon">
    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <h1 class="app-page-title">Lista vip-ów</h1>
                        ...
                        <div class="app-card app-card-basic d-flex flex-column shadow-sm">
                            <div class="app-card-header p-3 border-bottom-0">
                                <div class="row align-items-center gx-3">
                                    ...
                                    <!--//col-->
                                    <div class="col-auto">
                                        <h4 class="app-card-title">Vipy <button class="btn app-btn-secondary" data-bs-toggle="modal" data-bs-target="#addVipModal">
                                                Dodaj</button></h4>
                                    </div>
                                    <!--//col-->
                                </div>
                            ...
                            <div class="app-card-body px-4">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php foreach ($class->getVips() as $vip) : ?>
                                                <tr>
                                                    <td><?= $vip->id; ?></td>
                                                    <td><?= $vip->name; ?></td>
                                                    <td><?= $vip->steamid; ?></td>
                                                    <td><?= $vip->flags; ?></td>
                                                    <td><?= date_format(date_create($vip->expire), "d.m.Y"); ?></td>
                                                    <td><?= $vip->server_address == 'all' ? '<span class="badge bg-secondary">Wszystkie' : '<span class="badge" style="background-color: ' . $class->getRandomColor() . ';">' . $vip->server_name; ?></span></td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editVipModal-<?= $vip->id; ?>">Edytuj</button>

                                                                <!-- EditVipModal -->
                                                                <div class="modal fade" id="editVipModal-<?= $vip->id; ?>" tabindex="-1" aria-labelledby="editVipModal-<?= $vip->id; ?>" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="editVipModal">Edycja VIP-a <strong><?= $vip->name; ?></strong></h5>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form method="POST">
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <input type="text" class="form-control" id="vip_name" name="vip_name" value="<?= $vip->name; ?>" />
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="" class="form-label">SteamID</label>
                                                                                        <input type="text" class="form-control" id="vip_steamid" name="vip_steamid" value="<?= $vip->steamid; ?>" />
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <select class="form-select" name="vip_server">
                                                                                            <?php foreach ($class->getServers() as $server) :
                                                                                                ...
                                                                                                echo '<option value="' . $server->address . '" ' . ($vip->server_id == $server->id ? 'selected' : '') . '>' . $server->name . '</option>';

                                                                                            endforeach; ?>
                                                                                        </select>
                                                                                        <div class="form-check">
                                                                                            <input class="form-check-input" type="checkbox" value="" name="vip_all_servers" <?php echo $vip->server_address == 'all' ? 'checked' : ''; ?>>
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <select class="form-select" name="vip_flags">
                                                                                            <?php foreach ($class->getVipRoles() as $key) :

                                                                                                echo '<option value="' . $key . '" ' . ($vip->flags == $key ? 'selected' : '') . '>' . $key . '</option>';
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <input type="date" class="form-control" id="vip_expire" name="vip_expire" value="<?= $vip->expire; ?>" />
                                                                                    </div>
                                                                                    <div class="modal-footer">
                                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Zamknij</button>
                                                                                        <input type="hidden" value="<?= $vip->id; ?>" name="vip_id" />
                                                                                        <input type="hidden" value="<?= $vip->server_address; ?>" name="vip_address" />
                                                                                        <input type="submit" class="btn btn-primary" name="vip_edit" value="Edytuj" />
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                        </div>
    ...
    <!-- AddVipModal -->
    <div class="modal fade" id="addVipModal" tabindex="-1" aria-labelledby="addVipModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addVipModal">Dodawanie VIP-a</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Serwer</label>
                            <select class="form-select" name="server_address">
                                <?php foreach ($class->getServers() as $server) :
