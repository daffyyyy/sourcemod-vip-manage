...
if (isset($_POST['add_user']) && !empty($_POST['user_name']) && !empty($_POST['user_role']) && !empty($_POST['user_password'])) {
    $class->addUser($_POST);
}
if (isset($_POST['edit_user']) && !empty($_POST['user_name']) && !empty($_POST['user_role'])) {
    $class->editUser($_POST);
}
if (isset($_POST['delete']) && !empty($_POST['user_id'])) {
    $class->deleteUser($_POST['user_id']);
}
?>
...
<body class="app">
    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <h1 class="app-page-title">Lista użytkowników</h1>
                        ...
                        <div class="app-card app-card-basic d-flex flex-column shadow-sm">
                            <div class="app-card-header p-3 border-bottom-0">
                                <div class="row align-items-center gx-3">
                                    ...
                                    <!--//col-->
                                    <div class="col-auto">
                                        <h4 class="app-card-title">Użytkownicy <button class="btn app-btn-secondary" data-bs-toggle="modal" data-bs-target="#addUserModal">
                                                Dodaj</button></h4>
                                    </div>
                                    <!--//col-->
                                </div>
                            ...
                            <div class="app-card-body px-4">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php foreach ($class->getUsers() as $user) : ?>
                                                <tr>
                                                    <td><?= $user->id; ?></td>
                                                    <td><?= $user->name; ?></td>
                                                    <td><?= $user->role == "Administrator" ? '<span class="badge bg-danger">Administrator</span>' : '<span class="badge bg-secondary">Użytkownik</span>' ?></td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editUserModal-<?= $user->id; ?>">Edytuj</button>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="editUserModal-<?= $user->id; ?>">Edytowanie użytkownika <strong><?= $user->name; ?></strong></h5>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form method="POST">
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        <label for="" class="form-label">Rola</label>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <input type="submit" class="btn btn-primary" name="edit_user" value="Edytuj" />
                                                                            </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
    ...
    <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addUserModal">Dodawanie użytkownika</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Zamknij</button>
                    <input type="submit" class="btn btn-primary" name="add_user" value="Dodaj" />
                </div>
                </form>
            </div>
        </div>
